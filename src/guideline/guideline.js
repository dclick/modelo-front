...
$(function() {
	...
	var _oldShow = $.fn.collapse.Constructor.prototype.show;
	var _oldHide = $.fn.collapse.Constructor.prototype.hide;

	$.fn.collapse.Constructor.prototype.show = function() {
		_oldShow.apply(this, arguments);
		this.$element.prev().find(".accordion-toggle").addClass("accordion-open-icon");
	};

	$.fn.collapse.Constructor.prototype.hide = function() {
		_oldHide.apply(this, arguments);
		this.$element.prev().find(".accordion-toggle").removeClass("accordion-open-icon");
	};
});
(function($) {
  if($.fn.livequery) {
    $('[title]:not([data-notooltip])').livequery(function() {
    	$(this).tooltip();
    });
  }
}(jQuery));
...
(function($) {
  var navActions = {
    'close-application': function() { 
      if (confirm('Deseja sair da aplcação?')) {
